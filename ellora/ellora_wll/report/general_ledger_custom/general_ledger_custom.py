...
def get_gl_entries(filters, accounting_dimensions):
	...
	if filters.get("presentation_currency"):
		...
		# if filters.get("show_pdc_payments"):
		# 	frappe.log_error("conditions", get_conditions(filters))
		# 	frappe.log_error("glentries", gl_entries)
		# 	payment_entries = frappe.db.sql(
		# 		f"""
		# 			select
		# 				name as gl_entry, posting_date, paid_from as account, "Payment Entry" as voucher_type, name as voucher_no, 
		# 				payment_type as voucher_subtype, cost_center, project, creation, paid_amount as debit, paid_amount as debit_in_account_currency, 0 as credit, 0 as credit_in_account_currency
		...
		# 		as_dict=1,
		# 	)
		# 	frappe.log_error("payment_entries", payment_entries)
		# 	gl_entries.extend(payment_entries)
		return gl_entries
