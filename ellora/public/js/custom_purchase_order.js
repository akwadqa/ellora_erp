frappe.ui.form.on("Purchase Order Item", "custom_stock_info", function(frm, cdt, cdn) {
...
frappe.ui.form.on("Purchase Order Item", "custom_item_purchase_history", function(frm, cdt, cdn) {
    let child_doc = locals[cdt][cdn];
    let item_code = child_doc.item_code;
